...
<body>
    <div class="email-container">
        ...
        <div style="text-align: center;">
            @if($order->user)
                <a href="{{ route('customer.orders.show', ['orderNumber' => $order->order_number]) }}" class="cta-button">Track Your Order</a>
            @else
                <a href="{{ route('order.confirmation', ['order' => $order]) }}" class="cta-button">Track Your Order</a>
            @endif
        </div>
