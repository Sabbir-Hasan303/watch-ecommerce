        ...
        {accountStats.map((stat, index) => (
          <Card
            ...
            <div className='relative'>
              ...
              <h3 className='text-2xl md:text-3xl font-bold text-white mb-1 group-hover:text-emerald-400 transition-colors'>{stat.value}</h3>
        ...
        <Card className='bg-[#1C252E] border-white/5 p-6 animate-in fade-in slide-in-from-left-4'>
            ...
            {salesSummary.map((item, index) => (
              <div key={index} className='group cursor-pointer'>
                <div className='flex items-center justify-between mb-2'>
                  <span className='text-sm font-medium text-white group-hover:text-emerald-400 transition-colors'>{item.category}</span>
                  <div className='flex items-center gap-2'>
          ...
          <div className='mt-6 pt-6 border-t border-white/5'>
            <div className='flex items-center justify-between'>
              ...
              <span className='text-lg font-bold text-white'>${salesSummary.reduce((acc, item) => acc + item.revenue, 0).toLocaleString()}</span>
            </div>
          </div>
        </Card>
              ...
              <div
                ...
                <div className='flex items-center gap-3 ml-4'>
                  <div className='text-right'>
                    <p className={cn('text-sm font-semibold', transaction.type === 'income' ? 'text-emerald-400' : 'text-red-400')}>
