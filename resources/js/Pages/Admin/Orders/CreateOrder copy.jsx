...
export default function CreateOrder() {
    ...
    const handleCustomerSelect = (customer) => {
        ...
        if (customer.defaultShippingAddress) {
            setShippingAddress({
                ...
                zipCode: customer.defaultShippingAddress.zipCode,
                country: customer.defaultShippingAddress.country,
                area: 'inside_dhaka' // Default value
            })
    ...
    const addresses = [
        { id: 1, name: 'Address 1', value: 'address1' },
        { id: 2, name: 'Address 2', value: 'address2' },
        { id: 3, name: 'Address 3', value: 'address3' }
    ]
                                    ...
                                    <Card className='p-6 bg-card'>
                                        ...
                                        {showNewCustomerForm && (
                                            <Card className='p-4 mb-6 bg-muted/30 border-emerald-500/20  slide-in-from-top-2 duration-300'>
                                                <h3 className='font-semibold text-foreground mb-4'>Enter Guest Details</h3>
                                                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4'>
                                                    ...
                                                    <div>
                                                        <CustomTextField label='Full Name' name='fullName' value={newCustomerData.fullName} onChange={e => setNewCustomerData({ ...newCustomerData, fullName: e.target.value })} placeholder='John Doe' />
                                                    </div>
                                                    <div>
                                                        <CustomTextField label='Phone' name='phone' value={newCustomerData.phone} onChange={e => setNewCustomerData({ ...newCustomerData, phone: e.target.value })} placeholder='+1 (123) 456-7890' />
                                                    </div>
                                                    <div>
                                                        <CustomTextField label='Email' name='email' type='email' value={newCustomerData.email} onChange={e => setNewCustomerData({ ...newCustomerData, email: e.target.value })} placeholder='john.doe@example.com' />
                                                    </div>

                                                    <div>
                                                        <CustomTextField label='Full Address' name='address' value={newCustomerData.address} onChange={e => setNewCustomerData({ ...newCustomerData, address: e.target.value })} placeholder='123 Main St' />
                                                    </div>
                                                    <div>
                                                        <CustomSelectField label='Area' name='area' value={newCustomerData.area} onChange={e => setNewCustomerData({ ...newCustomerData, area: e.target.value })} placeholder='Inside Dhaka' options={[
                                        ...
                                        {/* Shipping Address - Hidden for Guest Customers */}
                                        {!showNewCustomerForm && (
                                            <Card className='p-6 bg-card border-border'>
                                                <div className='flex items-center gap-3 mb-6'>
                                                    ...
                                                    <div className='w-full flex flex-col md:flex-row justify-between items-center gap-3'>
                                                        ...
                                                        <div className='w-full md:w-1/2 flex gap-2'>
                                                            {/* Show address select only if customer has multiple addresses */}
                                                            {selectedCustomer && selectedCustomer.addresses && selectedCustomer.addresses.length > 1 && (
                                                                <CustomSelectField
                                                                    label="Choose Different Address"
                                                                    ...
                                                                    placeholder="Choose Different Address"
                                                                    className="flex-1"
                                                                />
                                                            )}
