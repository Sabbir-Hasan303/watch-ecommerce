      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-emerald-500/50 focus:ring-emerald-500/20 transition-all duration-300"
          />
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            {selectedCategory}
            <ChevronDown
              className={cn("w-4 h-4 ml-2 transition-transform duration-300", showCategoryDropdown && "rotate-180")}
            />
          </Button>

          {showCategoryDropdown && (
            <div className="absolute top-full mt-2 right-0 w-48 bg-[#1C252E] border border-white/10 rounded-lg shadow-2xl shadow-black/50 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2">
