...
import { Search, UserCheck, TrendingUp, Eye, MoreVertical } from 'lucide-react'
import { Button, InputAdornment, FormControl, Box, Typography, IconButton, Menu, MenuItem, TablePagination } from '@mui/material'
                        ...
                        <Card className='p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/20 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300'>
                            <div className='flex items-center justify-between'>
                                <div>
                                    ...
                                    <p className='text-2xl md:text-xl xl:text-3xl font-bold mt-1 flex items-center gap-1'><Taka color='text-purple-600 dark:text-purple-400' className='font-bold text-2xl md:text-xl xl:text-2xl' />{(totalRevenue.toFixed(2) || 0)}</p>
                                </div>
                                        ...
                                        {paginatedCustomers.length === 0 ? (
                                            ...
                                            paginatedCustomers.map(customer => (
                                                <TableRow key={customer.id} hover>
                                                    ...
                                                    <TableCell className='table-body-cell dark:table-body-cell'>
                                                        <Typography variant='body2' className='text-foreground'>
                                                            {customer.area || 'No area provided'}
                                                        </Typography>
                                                    </TableCell>
                                                    <TableCell className='table-body-cell dark:table-body-cell'>
                                                        <Typography variant='body2' className='text-foreground'>
                                                    ...
                                                    <TableCell className='table-body-cell dark:table-body-cell'>
                                                        <div className='flex items-center gap-1'><Taka className='text-sm' />{(Number(customer.totalSpent).toFixed(2) || 0)}</div>
                                                    </TableCell>
                                                    <TableCell className='table-body-cell dark:table-body-cell'>
                        ...
                        <DialogContent className='text-text-primary' sx={{ pt: 2 }}>
                            ...
                            <Box sx={{ mb: 3 }}>
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                                    ...
                                    <Box sx={{ p: 2, bgcolor: 'rgba(168, 85, 247, 0.05)', borderRadius: 1, border: '1px solid rgba(168, 85, 247, 0.1)' }}>
                                        <Typography variant='body2' sx={{ color: '#9CA3AF', mb: 0.5, fontWeight: 500 }}>
                                            Address
                                        </Typography>
                                        <Typography variant='body2' className='text-text-primary'>
                                    ...
                                    <Box sx={{ p: 2, bgcolor: 'rgba(168, 85, 247, 0.05)', borderRadius: 1, border: '1px solid rgba(168, 85, 247, 0.1)' }}>
                                        ...
                                        <Typography variant='body2' className='text-text-primary'>
                                            {selectedCustomer.area || 'No area provided'}
                                        </Typography>
                                    </Box>
                                </Box>
                            </Box>
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 2 }}>
                                    ...
                                    <Box
                                        ...
                                        <div className='flex justify-center items-center gap-1'>
                                            <Taka className='text-sm' />{(Number(selectedCustomer.totalSpent).toFixed(2) || 0)}
                                        </div>
                                    </Box>
                                </Box>
                            </Box>
