        ...
        <section className="relative w-full overflow-hidden">
            ...
            <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8 lg:pt-20 lg:pb-16">
                ...
                <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[550px] mb-8 lg:mb-6">
                    <div className="absolute right-[5%] sm:right-[8%] lg:right-[12%] top-1/3 -translate-y-1/2 w-[180px] h-[180px] sm:w-[280px] sm:h-[280px] lg:w-[380px] lg:h-[380px] bg-[linear-gradient(180deg,_#9BA8AE_0%,_#FFFFFF_100%)] rounded-full z-0 **pt-5 pr-5 sm:pt-16 sm:pr-16 lg:pt-20 lg:pr-20**">
                        {/* Price Badge */}
                        <div className="text-right">
                            <p className="text-2xl sm:text-3xl lg:text-5xl font-bold text-white">$12,500</p>
                            <p className="text-xs sm:text-sm lg:text-base text-white/90 mt-1">Starting from</p>
                        </div>
                    </div>
                ...
                <div className="max-w-[1024px] mx-auto">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 lg:gap-12 opacity-60">
                        <div className="rounded-full overflow-hidden border w-8 h-8 lg:w-24 lg:h-24">
                            <img
                                src="/images/design-mode/Rolex-Logo-Transparent-PNG.png"
                                alt="Rolex"
                        ...
                        <div className="rounded-full overflow-hidden border w-8 h-8 lg:w-24 lg:h-24">
                            <img
                                src="/images/design-mode/patek-philippe-logo.png"
                                alt="Patek Philippe"
                                className="h-full object-cover grayscale"
                            />
                        </div>
                        ...
                        <div className="rounded-full overflow-hidden border w-8 h-8 lg:w-24 lg:h-24">
                            <img
                                src="/images/design-mode/tag-heuer-watch-logo-brand-png-favpng-fgMz5TczwvfTRPVkz4hKMge34.jpg"
                                alt="TAG Heuer"
                                className="h-full object-cover grayscale"
                            />
                        </div>
